...
<body>
            ...
            <div class="navbar navbar-inverse navbar-static-top">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        ...
                        <a class="brand" href="{{URL::to('/')}}">{{ $cpanel['site_name_short'] }}</a> <!-- .topnav -->
                        @if (Sentry::check())
                            ...
                            <div class="nav-collapse collapse">
                                <!-- .nav -->
                                <ul class="nav">
                                    <li><a href="{{route('cpanel.home')}}"><span class="icon-home"></span></a></li>
    ...
    <div id="footer">
        <p><?php echo date('Y');?> © {{ $cpanel['site_name'] }} </p>
    </div>
