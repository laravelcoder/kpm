	...
	<div class="single">
		<div class="container">
			  <div class="col-md-9">
				...
				<div class="grid_1">
					<div class="schedule-filter">
						<form action="">
							<label>{{_('Група')}}</label>
							{{ Form::select( "group" , $groups, Input::old( "group", $group ) , array( 'class'=>'form-control col-sm-6 input-small') ) }}
			 ...
			 <div class="col-md-3 sidebar">
					<h3><a href="{{action('PagesController@getTeacherSchedule')}}">{{_('Розклад для викладачів')}}</a></h3>
