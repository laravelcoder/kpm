...
@section('content')
    ...
    <h1>Список предметів <br><small>{{$university->name}}</small></h1>
    ...
    <div class="pull-right">
        @if (allowed('subjects', 'new'))
        <a href="{{route('subjectAdd', $id)}}" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Додати</a>
        @endif
    </div>
@stop
