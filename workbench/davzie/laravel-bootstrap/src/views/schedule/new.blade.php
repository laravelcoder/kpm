...
@section('heading')
    <h1>Додавання розкладу <small>Група {{$group->title}}</small></h1>
@stop
...
@section('form-items')
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::select( "faculty_id" , ['' => ''] + $faculties, Input::old( "faculty_id" ) , array( 'class'=>'form-control js-select-dropdown', 'data-url' => '/api/departments/' , 'data-target' => '[name=department_id]', 'placeholder'=>'Факультет' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::select( "department_id" , ['' => ''] + $departments, Input::old( "department_id" ) , array( 'class'=>'form-control js-select-dropdown', 'data-url' => '/api/department-teachers/' , 'placeholder'=>'Кафедра', 'data-target' => '[name=teacher_id]' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::select( "teacher_id" , ['' => ''] + $teachers, Input::old( "teacher_id" ) , array( 'class'=>'form-control js-select-dropdown', 'data-url' => '/api/teachers-subjects/' , 'placeholder'=>'Викладач','data-target' => '[name=subject_id]', ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::select( "subject_id" , ['' => ''] + $subjects, Input::old( "subject_id" ) , array( 'class'=>'form-control', 'placeholder'=>'Предмет' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::select( "subject_type_id" , $subj_types, Input::old( "subject_type_id" ) , array( 'class'=>'form-control ', 'data-url' => '' , 'placeholder'=>'Тип заняття' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::select( "building_id" , ['' => ''] + $buildings, Input::old( "building_id" ) , array( 'class'=>'form-control js-select-dropdown', 'data-url' => '/api/classrooms/' , 'placeholder'=>'Корпус', 'data-target' => '[name=classroom_id]' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::select( "classroom_id" , ['' => ''] + $classrooms, Input::old( "classroom_id" ) , array( 'class'=>'form-control', 'placeholder'=>'Аудиторія' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::select( "weeks[]" , $weeks, Input::old( "weeks[]" ) , array( 'class'=>'form-control sel2', 'multiple' ) ) }}
        </div>
    </div>
