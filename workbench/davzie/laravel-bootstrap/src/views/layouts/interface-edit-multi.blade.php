            ...
            <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header js-modal-title">Title</div>
                        <div class="modal-body">
                            <iframe src="" style="width:100%; height: 420px;" frameborder="0" class="js-frame"></iframe>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default js-close-modal" data-dismiss="modal" data-reload>Close</button>
                          </div>
                    </div>
                </div>
            </div>
