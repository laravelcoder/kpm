...
@section('heading')
    <h1>Редагування розкладу дзвінків <small>{{$university->name}}</small></h1>
@stop
...
@section('form-items')
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::text( "time_start" , Input::old( "time_start", $item->time_start ) , array( 'class'=>'form-control timepicker' , 'placeholder'=>'Час початку' ) ) }}
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            {{ Form::text( "time_end" , Input::old( "time_end", $item->time_end ) , array( 'class'=>'form-control timepicker' , 'placeholder'=>'Час завершення' ) ) }}
        </div>
    </div>
